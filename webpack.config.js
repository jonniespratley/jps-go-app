...
const configurator = {
  entries: function () {
    var entries = {
      application: ['./node_modules/jquery-ujs/src/rails.js', './assets/css/application.scss']
    }
  ...
  plugins() {
    var plugins = [
      new CleanObsoleteChunks(), new Webpack.ProvidePlugin({$: "jquery", jQuery: "jquery"}),
  ...
  buildConfig: function () {
    ...
    if (env === "development") {
      config
        .plugins
        .push(new LiveReloadPlugin({appendScriptTag: true}))
      return config
    }
